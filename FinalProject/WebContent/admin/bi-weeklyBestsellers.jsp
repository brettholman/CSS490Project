...
<section>
	<h1>Best Sellers</h1><a href="bestsellers.jsp">Click for Monthly results</a>
<%
	...
	ArrayList<Pair<InventoryItem, String>> items = inventoryDB.getBiWeeklyBestSellers(max, categoryID);
	if(items != null) {
%>
